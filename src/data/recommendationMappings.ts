...
export default { SYMPTOM_CATEGORIES, SYMPTOM_RECOMMENDATIONS_DETAILED, GOAL_RECOMMENDATIONS_DETAILED, LIFESTYLE_RECOMMENDATIONS, SYMPTOM_INTENSITY, GOAL_INTENSITY, AGE_FACTORS, GENDER_FACTORS, SYMPTOM_PRIORITY_FACTORS };